...
gamemodes = {"blitz": "chess_blitz", "rapid": "chess_rapid", "bullet": "chess_bullet", "daily": "chess_daily"}
...
class Chess(commands.Cog):
    ...
    async def _info(self, ctx, *args):
        try:
            player, mode = args
            stats = chessdotcom.client.get_player_stats(player).json[gamemodes[mode]]
